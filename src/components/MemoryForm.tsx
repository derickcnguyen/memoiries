...
export const MemoryForm: React.FC<MemoryFormProps> = ({
  ...
  return (
    <form
      ...
      className="space-y-6 p-6 bg-white border-2 border-black rounded-lg shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]"
    >
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div>
            <label className="block text-sm mb-1">Mood Color</label>
            <input
              type="color"
